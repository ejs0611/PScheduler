...
//	/** Minimum count of letters in the Course */
//	private static final int MIN_LETTER_COUNT = 1;
//	/** Maximum count of letters in the Course */
//	private static final int MAX_LETTER_COUNT = 4;
//	/** Required count of digits in the Course */
//	private static final int DIGIT_COUNT = 3;
	 ...
	 * @param enrollmentCap enrollment cap
	...
	public Course(String name, String title, String section, int credits, String instructorId, int enrollmentCap, String meetingDays,
		...
		CourseNameValidator wasd = new CourseNameValidator();
		try {
			if(wasd.isValid(name)) {
				setName(name);
			} else {

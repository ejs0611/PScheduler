...
/** the test class that is used to test the course name validator.
 *
 */
public class CourseNameValidatorTest {
	...
	public void testIsValid() throws InvalidTransitionException{
		...
		CourseNameValidator thing = new CourseNameValidator();
		...
		String fourLThreeDTwoS = "cscs116aa";
	...
	//	String other = null;
		...
		InvalidTransitionException e9 = new InvalidTransitionException();
		assertEquals("Invalid FSM Transition.", e9.getMessage());

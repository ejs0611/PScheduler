...
public class RegistrationManagerTest {
	...
	public void testGetCourseCatalog() {
		...
		CourseCatalog wasd = new CourseCatalog();
		wasd.addCourseToCatalog("CSC116", "Intro to Programming - Java", "001", 3, "jdyoung2", 50, "MW", 910, 1100);
		
		assertEquals("CSC116", wasd.getCourseFromCatalog("CSC116", "001").getName());
	...
	public void testGetStudentDirectory() {
		...
		StudentDirectory wasd = new StudentDirectory();
		wasd.loadStudentsFromFile("test-files/student_records.txt");
		
		assertEquals(manager.getStudentDirectory().getStudentById("daustin"), wasd.getStudentById("daustin"));
	...
	public void testLogin() {
		StudentDirectory x = manager.getStudentDirectory();
		x.addStudent("bob", "jones", "bjones", "bjones@ncsu.edu", "123", "123", 18);
		x.addStudent("bob2", "jones2", "bjones2", "bjones2@ncsu.edu", "123", "123", 18);
		assertTrue(manager.login("bjones", "123"));
		assertFalse(manager.login("bjones2", "123"));
		manager.logout();
		assertFalse(manager.login("bjones", "1"));
	...
	public void testLogout() {
		RegistrationManager wasd = RegistrationManager.getInstance();
		wasd.clearData();
		manager.logout();
	...
	public void testGetCurrentUser() {
		StudentDirectory x = manager.getStudentDirectory();
		x.addStudent("bob", "jones", "bjones", "bjones@ncsu.edu", "123", "123", 18);
		manager.login("bjones", "123");
		assertEquals("jones", manager.getCurrentUser().getLastName());
	}

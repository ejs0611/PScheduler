...
public class StudentTest {
	...
	public void testCanAdd() {
		Course c1 = new Course("CSC216", "Software Development Fundamentals", "001", 3, "sesmith5", 50, "MW", 1330,
				1445);
		Course c2 = new Course("CSC216", "Software Development Fundamentals", "002", 3, "sesmith5", 50, "MW", 1345,
				1430);
		Course c3 = new Course("CSC216", "Software Development Fundamentals", "003", 3, "sesmith5", 50, "MW", 1200,
				1345);
		Course c4 = new Course("CSC216", "Software Development Fundamentals", "001", 3, "sesmith5", 50, "MW", 1330,
				1445);
		Student s = new Student("first", "last", "id", "email@ncsu.edu", "hashedpassword");
